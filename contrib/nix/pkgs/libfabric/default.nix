{
  ...
  # OPX requires Cornelis proprietary headers (hfi1dv.h) not in nixpkgs rdma-core
  enableProvOpx ? false,
  enableProvPsm2 ? stdenv.hostPlatform.isLinux && stdenv.hostPlatform.isx86_64 && libpsm2 != null,
