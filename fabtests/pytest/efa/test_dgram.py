import pytest
import copy
from efa.efa_common import efa_retrieve_hw_counter_value, DGRAM_PR_CI
from common import PERF_SIZES

# this test must be run in serial mode because it check hw counter
@pytest.mark.pr_ci
@pytest.mark.message_sizes(default=PERF_SIZES, pr_ci=DGRAM_PR_CI)
@pytest.mark.serial
