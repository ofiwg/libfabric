...
* The libfabric library itself (including documentation): [libfabric v1.5.0](https://github.com/ofiwg/libfabric/releases/tag/v1.5.0) (or [see all prior releases](https://github.com/ofiwg/libfabric/releases/)).
...
* [Man pages for v1.5.0](v1.5.0/man/)
