...
* The libfabric library, unit tests, and documentation: [libfabric v1.13.1](https://github.com/ofiwg/libfabric/releases/tag/v1.13.1) (or [see all prior releases](https://github.com/ofiwg/libfabric/releases/)).
...
* [Man pages for v1.13.1](v1.13.1/man/)
