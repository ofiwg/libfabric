...
* The libfabric library, unit tests, and documentation: [libfabric v2.5.1](https://github.com/ofiwg/libfabric/releases/tag/v2.5.1) (or [see all prior releases](https://github.com/ofiwg/libfabric/releases/)).
...
* [Man pages for v2.5.1](v2.5.1/man/)
