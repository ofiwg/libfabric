...
* The libfabric library itself (including documentation): [libfabric v1.8.1](https://github.com/ofiwg/libfabric/releases/tag/v1.8.1) (or [see all prior releases](https://github.com/ofiwg/libfabric/releases/)).
* Examples and unit tests: [fabtests v1.8.1](https://github.com/ofiwg/libfabric/releases/tag/v1.8.1) (or [see all prior releases](https://github.com/ofiwg/fabtests/releases/)).
...
* [Man pages for v1.8.1](v1.8.1/man/)
