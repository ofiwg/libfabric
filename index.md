...
* The libfabric library, unit tests, and documentation: [libfabric v1.13.2](https://github.com/ofiwg/libfabric/releases/tag/v1.13.2) (or [see all prior releases](https://github.com/ofiwg/libfabric/releases/)).
...
* [Man pages for v1.13.2](v1.13.2/man/)
