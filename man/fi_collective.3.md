...
int fi_join_collective(struct fid_ep *ep, const struct fid_av_set *set,
	uint64_t flags, struct fid_mc **mc, void *context);

ssize_t fi_barrier(struct fid_ep *ep, fi_addr_t coll_addr, uint64_t flags,
	void *context);
...
the collective.  The fi_join flags may be used to restrict access to the
