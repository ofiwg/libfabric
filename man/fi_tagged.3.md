...
*buf*
: Data buffer to send or receive. For 0-byte operations, buf may be NULL.
...
: Memory descriptor associated with the data buffer. For 0-byte operations,
  desc may be NULL even for FI_MR_LOCAL. See [`fi_mr`(3)](fi_mr.3.html).
...
For 0-byte operations, msg_iov and desc may be NULL and iov_count may be 0.
The desc may be NULL even for FI_MR_LOCAL.
