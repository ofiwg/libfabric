...
/*
 * TODO: GRND_INSECURE (available on kernels 5.10+) is the best option
 * for non-blocking random number generation. It does not require opening
 * an FD to /dev/urandom. See:
