...
#ifndef _EFA_RDM_PROTO_LONGCTS_WRITE_H
#define _EFA_RDM_PROTO_LONGCTS_WRITE_H

#include "efa_rdm_proto.h"

extern struct efa_rdm_proto efa_rdm_proto_longcts_write;
...
#endif /* _EFA_RDM_PROTO_LONGCTS_WRITE_H */
