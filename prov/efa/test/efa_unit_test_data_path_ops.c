 ...
 *
 * The EFA_DATA_PATH_OPS_EMIT_BODIES macro _has_ to be defined before the first
 * include that could reach efa_data_path_ops.h. Otherwise, linking will fail
 * with undefined references to efa_qp_post_*.
 */
