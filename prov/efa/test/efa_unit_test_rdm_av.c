...
void test_av_rdm_batch_insert(void **state)
{
	...
	test_av_verify_av_hash_cnt(av, rdm_av, 3, 0, 0, 0);
	...
	test_av_verify_av_hash_cnt(av, rdm_av, 2, 0, 0, 0);
...
void test_av_rdm_prv_reverse_av(void **state)
{
	...
	test_av_verify_av_hash_cnt(av, rdm_av, 0, 1, 0, 0);
...
void test_av_implicit_av_lru_move_single(void **state)
{
	...
	test_av_implicit_av_verify_lru_list_first_last_elements(
		rdm_av, peer->av_entry, peer->av_entry);
}
