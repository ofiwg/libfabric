...
static void test_efa_rma_prep(struct efa_resource *resource, fi_addr_t *addr)
{
	...
	base_ep->qp->post_recv = &efa_mock_ibv_post_recv;
	base_ep->qp->wr_complete = &efa_mock_ibv_wr_complete_no_op;
	base_ep->qp->wr_rdma_read = &efa_mock_ibv_wr_rdma_read_save_wr;
	base_ep->qp->wr_rdma_write = &efa_mock_ibv_wr_rdma_write_save_wr;
	base_ep->qp->wr_rdma_write_imm =
		&efa_mock_ibv_wr_rdma_write_imm_save_wr;
	base_ep->qp->wr_send = &efa_mock_ibv_wr_send_save_wr;
	base_ep->qp->wr_send_imm = &efa_mock_ibv_wr_send_imm_save_wr;
	base_ep->qp->wr_set_inline_data_list =
		&efa_mock_ibv_wr_set_inline_data_list_no_op;
	base_ep->qp->wr_set_sge_list = &efa_mock_ibv_wr_set_sge_list_no_op;
	base_ep->qp->wr_set_ud_addr = &efa_mock_ibv_wr_set_ud_addr_no_op;
	base_ep->qp->wr_start = &efa_mock_ibv_wr_start_no_op;
