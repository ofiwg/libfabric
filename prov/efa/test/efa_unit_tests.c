...
int main(void)
{
	...
	const struct CMUnitTest efa_unit_tests[] = {
		...
		cmocka_unit_test_setup_teardown(test_efa_rdm_ep_has_unfinished_send_with_error_completion, efa_unit_test_mocks_setup, efa_unit_test_mocks_teardown),
		...
		cmocka_unit_test_setup_teardown(test_efa_rdm_peer_recvwin_queue_or_append_pke_ooo_copy, efa_unit_test_mocks_setup, efa_unit_test_mocks_teardown),
