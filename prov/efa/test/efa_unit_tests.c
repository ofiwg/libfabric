...
int main(void)
{
	...
	const struct CMUnitTest efa_unit_tests[] = {
		...
		cmocka_unit_test_setup_teardown(test_efa_cuda_dmabuf_support_ibv_reg_mr_fail_disable_p2p_fallback_keygen, efa_unit_test_mocks_setup, efa_unit_test_mocks_teardown),
		cmocka_unit_test_setup_teardown(test_efa_cuda_dmabuf_support_ibv_reg_mr_fail_retain_p2p_fallback_keygen, efa_unit_test_mocks_setup, efa_unit_test_mocks_teardown),
