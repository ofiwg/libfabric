...
void test_efa_rdm_ep_get_runt_size_no_enough_runt();
void test_efa_rdm_ep_get_runt_size_cuda_memory_smaller_than_alignment();
void test_efa_rdm_ep_get_runt_size_cuda_memory_exceeding_total_len();
void test_efa_rdm_ep_get_runt_size_cuda_memory_normal();
void test_efa_rdm_ep_get_runt_size_host_memory_smaller_than_alignment();
void test_efa_rdm_ep_get_runt_size_host_memory_exceeding_total_len();
void test_efa_rdm_ep_get_runt_size_host_memory_normal();
void test_efa_rdm_ep_select_readbase_rtm_no_runt();
void test_efa_rdm_ep_select_readbase_rtm_do_runt();
