...
void test_efa_cuda_dmabuf_support_ibv_reg_mr_fail_disable_p2p_fallback_keygen();
void test_efa_cuda_dmabuf_support_ibv_reg_mr_fail_retain_p2p_fallback_keygen();
