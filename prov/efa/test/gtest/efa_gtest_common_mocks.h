...
#define EFA_MOCK_PARAMS_efa_direct_ope_release \
	struct efa_base_ep *base_ep, struct efa_direct_ope *direct_ope
#define EFA_MOCK_ARGS_efa_direct_ope_release base_ep, direct_ope
