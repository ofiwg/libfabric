...
/**
 * @brief Undo the sink redirection and clear the staged-work state, so the
 * endpoint can be closed cleanly. Idempotent.
 * 
 * Must run before the endpoint is closed: a FI_MORE test
